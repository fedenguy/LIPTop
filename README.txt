...
runLocalAnalysisOverSamples.py -e showControlDistributions -j data/samples-signal.json -o ${HOME}/scratch0/top-newjec -d /store/cmst3/user/psilva/Top_ntuples_14Jan  -c test/runAnalysis_cfg.py.templ -l 4565 -p "@sfMetCut=40 @ofMetCut=0 @jetPtCut=30 @runSystematics=True" -s 8nh

runLocalAnalysisOverSamples.py -e showControlDistributions -j data/syst-samples.json -o ${HOME}/scratch0/top-newjec -d /store/cmst3/user/psilva/Top_ntuples_14Jan  -c test/runAnalysis_cfg.py.templ -l 4565 -p "@sfMetCut=40 @ofMetCut=0 @jetPtCut=30 @runSystematics=True" -s 8nh
